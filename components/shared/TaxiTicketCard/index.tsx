...
import { PassengerCountType } from '@/types/taxi-ticket';
...
export default function TaxiTicketCard({
  ticketId,
  busName,
  busImage,
  passengers,
        ...
        <div className="p-2 flex flex-col gap-4">
          <div className="flex justify-between">
            <div className="flex gap-2">
              ...
              <div>
                <div>{busName}</div>
                <div className="text-[var(--color-gray-500)] text-xxs mt-1">{generalDictionary.adult}: {passengers.adult}, {generalDictionary.child}: {passengers.child}</div>
              </div>
            </div>
